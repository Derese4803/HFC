...
def main():
    ...
    if constraints_df is None or logic_df is None:
        st.error("Data missing. Ensure Constriantt.csv and Logicc.csv are in the repo root.")
        return
    ...
    if selected_enum != "-- Select ID --":
        ...
        with tab2:
            if st.session_state.admin_logged_in:
                ...
                # ... (Admin logic remains the same as previously defined)
            else:
                st.warning("🔒 Please login as admin in the sidebar.")
